...
log_dir=./rhrc_logs
save_dir=./rhrc_checkpoints
mkdir -p $log_dir $save_dir

bpe_dir=../../utils/BPE
user_dir=../../ofa_module

data_dir=../../dataset/rhrc
data=${data_dir}/capcihp_train.tsv,${data_dir}/capcihp_val.tsv
  ...
  for warmup_ratio in 0.06; do
    ...
    for drop_worst_after in 2500; do
      ...
      CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --nproc_per_node=1 --master_port=${MASTER_PORT} ../../train.py \
          ...
          --eval-args='{"beam":5,"max_len_b":50,"no_repeat_ngram_size":3}' \
