...
log_dir=/data2/RefHCM_train/hoi_logs_name
save_dir=/data2/RefHCM_train/hoi_checkpoints_name
mkdir -p $log_dir $save_dir

bpe_dir=../../utils/BPE
user_dir=../../ofa_module

data_dir=../../dataset/hoi
data=${data_dir}/hoi_vcoco_train.tsv,${data_dir}/hoi_vcoco_test.tsv
