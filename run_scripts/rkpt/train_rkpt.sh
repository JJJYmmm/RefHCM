...
data_dir=../../dataset/rkpt
data=${data_dir}/refcoco_pose_train.tsv,${data_dir}/refcoco_pose_testA.tsv
...
# --validate-interval=1 --save-interval-updates=500 --validate-interval-updates=500 \
# --eval-acc \
# --eval-args='{"beam":5,"min_len":4}' \
# --best-checkpoint-metric=oks_score --maximize-best-checkpoint-metric \