...
from data.mm_data.rpar_dataset import RParDataset
...
@register_task("rpar", dataclass=RParConfig)
class RParTask(OFATask):
    def __init__(self, cfg: RParConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = RParDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
    ...
    def valid_step(self, sample, model, criterion):
        ...
        if self.cfg.eval_acc:
            ...
            if len(self.cfg.vq_config):
                print("vq_config: " + self.cfg.vq_config)
