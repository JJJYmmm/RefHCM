...
from data.mm_data.rhrc_dataset import RHrcDataset
...
@register_task("rhrc", dataclass=RHrcConfig)
class RHrcTask(OFATask):
    def __init__(self, cfg: RHrcConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = RHrcDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
