...
class VQModel(pl.LightningModule):
    ...
    def to_rgb(self, x):
        ...
        x = F.conv2d(x, weight=self.colorize.to(x))
...
class VQSegmentationModel(VQModel):
    def __init__(self, n_labels, *args, **kwargs):
        ...
        label_color = [(0, 0, 0), (128, 0, 0), (255, 0, 0), (0, 85, 0), (170, 0, 51), (255, 85, 0), (0, 0, 85), (0, 119, 221), (85, 85, 0), (0, 85, 85), (85, 51, 0), (52, 86, 128), (0, 128, 0), (0, 0, 255), (51, 170, 221), (0, 255, 255), (85, 255, 170), (170, 255, 85), (255, 255, 0), (255, 170, 0)]
        self.colorize = torch.tensor(label_color).permute(1,0).unsqueeze(-1).unsqueeze(-1)
