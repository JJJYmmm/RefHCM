...
@register_model("refhcm")
class RefHCM(TransformerModel):
    ...
    @staticmethod
    def add_args(parser):
        super(RefHCM, RefHCM).add_args(parser)
        parser.add_argument(
            "--pooler-dropout",
            type=float,
            metavar="D",
    ...
    def forward(
        ...
        full_mask_position: Optional[tuple[int]] = None # for full mask decoding, a tuple of begin and end
    ):
        ...
        x, extra = self.decoder(
            ...
            src_lengths=src_lengths,
            return_all_hiddens=return_all_hiddens,
            full_mask_position=full_mask_position
        )
...
@register_model_architecture("refhcm", "refhcm")
def refhcm_architecture(args):
