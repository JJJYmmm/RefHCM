...
class RefcocoDataset(OFADataset):
    def __init__(
        ...
        if type(bpe).__name__ == 'GPT2BPE':
            ...
            # 6 words
            #  num of tokens > 6   desc ribe
            # which region does the text desc ribe?
            # dict from gpt2
            # 1 3 5 1201 2312 2323 1212 \in [0, 20265)

            # img: res101 -> img feature -> resampler(Linear) -> final img feature

            # tokens

            # vocab one to one map
            # vocab : matrix, [50265, 768]

            # shape: [num_toknes, dim_tokens]
